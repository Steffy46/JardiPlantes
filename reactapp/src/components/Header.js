...
function Header(){
    ...
    const productListItems = productsList.map((plant, i) => {
      ...
      return (<PlantItem key={i} likePlant={isSee} handleClickDeletePlantParent={handleClickDeletePlant} handleClickAddPlantParent={handleClickAddPlant} name={plant.name} />
      )
    })
    ...
    //       <NavItem>
    //         <NavLink>
    //           <Button id="Popover1"  type="button">{productsCount} Wishlist</Button>
